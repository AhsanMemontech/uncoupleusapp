...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1e2a3b] px-4">
      <form onSubmit={handleLogin} className="bg-gray-800 rounded-xl shadow-lg p-8 w-full max-w-md space-y-6">
        <h2 className="text-2xl font-bold text-white mb-4 text-center">Log In</h2>
